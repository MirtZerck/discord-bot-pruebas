...
export const createInteractionEmbed = (
  ...
  return new EmbedBuilder()
    .setAuthor({
      // Configura el autor del mensaje embed como el autor de la interacción y el tipo de interacción.
    ...
    .setFooter({ text: "¡Un gesto amable hace el día mejor!" }) // Configura el pie de página del mensaje embed.
